...
To encourage users to contribute to your showcase page, use the [`<ShowcaseCTA>`](/components/showcasecta/) component.

<ShowcaseCTA>Have you built a showcase page? [Open a PR](#call-to-action-cta) to add it to the list!</ShowcaseCTA>

## Text

To showcase text entries, use the [`<ShowcaseText>`](/components/showcasetext/) component.
...
To showcase image entries, use the [`<ShowcaseImage>`](/components/showcaseimage/) component.
...
To showcase video entries, use the [`<ShowcaseYoutube>`](/components/showcaseyoutube/) component.
...
To showcase Twitter (also known as X), use the [`<ShowcaseTwitter>`](/components/showcasetwitter/) component.
...
To showcase quote entries, use the [`<ShowcaseQuote>`](/components/showcasequote/) component.
...
<ShowcaseQuote
  entries={[
    ...
    {
      quote: 'The best documentation tool!<br/><br/>Had a great experience using it for the first time.',
      handle: 'HiDeoo',
      href: 'https://github.com/HiDeoo',
    },
  ]}
